...
bind "kwin" "KrohnkiteShiftLeft" "Meta+Shift+H" "Meta+Shift+Left"
bind "kwin" "KrohnkiteShiftRight" "Meta+Shift+L" "Meta+Shift+Right"
bind "kwin" "KrohnkiteShiftDown" "Meta+Shift+J" "Meta+Shift+Down"
bind "kwin" "KrohnkiteShiftUp" "Meta+Shift+K" "Meta+Shift+Up"

bind "kwin" "KrohnkiteShrinkWidth" "Meta+Ctrl+H" "Meta+Ctrl+Left"
bind "kwin" "KrohnkiteGrowWidth" "Meta+Ctrl+L" "Meta+Ctrl+Right"
